...
function assertCodegen (template, assertTemplate, options, parmas = {}) {
  ...
  const slotMetadata = value => Object.keys(value).reduce((res, key) => {
    res[key] = {
      name: value[key].name,
      slotId: value[key].slotId
    }
    return res
  }, {})
  expect(slotMetadata(output.slots)).toEqual(slotMetadata(slots))
...
describe('指令', () => {
  ...
  it('v-for', () => {
    ...
    // Iterator-scoped component data uses the platform-safe underscore separator.
    assertCodegen(
      `<div><my-component v-for="item in items" :key="item.id"></my-component></div>`,
      `<import src="/components/card" /><template name="a"><view class="_div hashValue"><template wx:key="item.id" data="{{...$root[$kk+'0_'+index], $root}}" is="my-component" wx:for="{{items}}" wx:for-index="index" wx:for-item="item"></template></view></template>`,
      {
        name: 'a',
        components: {
          'my-component': {
  ...
  it('v-if && event', () => {
    assertCodegen(
      ...
      `<template name="a"><view wx:if="{{item.length}}" bindtap="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_div"></view></template>`,
      { name: 'a' }
    )
  })
  ...
  it('v-if && v-for && event', () => {
    assertCodegen(
      ...
      `<template name="a"><view class="_div"><view wx:if="{{item.length}}" bindtap="handleProxy" data-eventid="{{'1_0_'+index}}" data-comkey="{{$k}}" wx:for="{{list}}" wx:for-index="index" wx:for-item="item" class="_p"></view></view></template>`,
      { name: 'a' }
    )
  })
  ...
  it('v-for && event', () => {
    assertCodegen(
      ...
      `<template name="a"><view class="_div"><view bindtap="handleProxy" data-eventid="{{'1_0_'+index}}" data-comkey="{{$k}}" wx:for="{{list}}" wx:for-index="index" wx:for-item="item" class="_p"></view></view></template>`,
      { name: 'a' }
    )
  })
...
describe('事件', () => {
  it('@click', () => {
    assertCodegen(
      `<a @click="ddd"></a>`,
      `<template name="a"><view bindtap="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_a"></view></template>`,
      { name: 'a' }
    )
  })
  ...
  it('@click.stop', () => {
    assertCodegen(
      `<a @click.stop="ddd"></a>`,
      `<template name="a"><view catchtap="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_a"></view></template>`,
      { name: 'a' }
    )
  })
  ...
  it('@click.stop.capture', () => {
    assertCodegen(
      ...
      `<template name="a"><view capture-catch:tap="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_a"></view></template>`,
      { name: 'a' }
    )
  })
  ...
  it('@click.capture', () => {
    assertCodegen(
      ...
      `<template name="a"><view capture-bind:tap="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_a"></view></template>`,
      { name: 'a' }
    )
  })
  ...
  it('@load', () => {
    assertCodegen(
      `<a @load="ddd"></a>`,
      `<template name="a"><view bindload="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_a"></view></template>`,
      { name: 'a' }
    )
  })
  ...
  it('v-on', () => {
    assertCodegen(
      ...
      `<template name="a"><button bindtap="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_button">Say hi</button></template>`,
      { name: 'a' }
    )
  })
  it('v-once', () => {
  ...
  it('bindmarkertap', () => {
    assertCodegen(
      ...
      `<template name="a"><map bindmarkertap="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_map"></map></template>`,
      { name: 'a' }
    )
  })
  it('v-else', () => {
    assertCodegen(
      ...
      `<template name="a"><view class="_div"><view wx:if="{{type === 'A'}}" bindtap="handleProxy" data-eventid="{{'1_3'}}" data-comkey="{{$k}}" class="_div">A</view><view wx:elif="{{type === 'B'}}" bindtap="handleProxy" data-eventid="{{'1_0'}}" data-comkey="{{$k}}" class="_div">B</view><view wx:elif="{{type === 'C'}}" bindtap="handleProxy" data-eventid="{{'1_1'}}" data-comkey="{{$k}}" class="_div">C</view><view wx:else bindtap="handleProxy" data-eventid="{{'1_2'}}" data-comkey="{{$k}}" class="_div">Not A/B/C</view></view></template>`,
      { name: 'a' }
    )
  })
})
...
describe('表单', () => {
  it('textarea', () => {
    assertCodegen(
      ...
      `<template name="a"><textarea value="{{message}}" bindinput="handleProxy" placeholder="add multiple lines" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_textarea" /></template>`,
      { name: 'a' }
    )
  })
  // 需要核实是否支持
  it('select', () => {
    assertCodegen(
      ...
      `<template name="a"><picker value="{{selected}}" bindchange="handleProxy" multiple style="width: 50px" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_select"></picker></template>`,
      { name: 'a' }
    )
  })
  it('v-model', () => {
    assertCodegen(
      ...
      `<template name="a"><input value="{{message}}" bindinput="handleProxy" placeholder="edit me" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_input" /></template>`,
      { name: 'a' }
    )
  })
  it('v-model.lazy', () => {
    assertCodegen(
      ...
      `<template name="a"><input value="{{msg}}" bindblur="handleProxy" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_input" /></template>`,
      { name: 'a' }
    )
  })
  it('v-model.number', () => {
    assertCodegen(
      ...
      `<template name="a"><input value="{{age}}" bindinput="handleProxy" type="number" data-eventid="{{'0_0'}}" data-comkey="{{$k}}" class="_input" /></template>`,
      { name: 'a' }
    )
  })
  it('radio', () => {
...
describe('template', () => {
  it('template', () => {
    assertCodegen(
      ...
      `<import src="/components/card" /><template name="a"><view class="_div data-v-djskdksdksdjkksdks"><template data="{{...$root[$kk+'0_'+index], $root}}" is="card" wx:for="{{10}}" wx:for-index="index" wx:for-item="i"></template></view></template>`,
      {
        name: 'a',
        components: {
          card: {
...
describe('onchange', () => {
  it('onchange', () => {
    assertCodegen(
      ...
      `<template name="a"><view class="_div hashValue baz boo"><picker bindchange="handleProxy" data-eventid="{{'1_0'}}" data-comkey="{{$k}}" class="_picker hashValue"></picker> <input bindblur="handleProxy" data-eventid="{{'1_1'}}" data-comkey="{{$k}}" class="_input hashValue" /></view></template>`,
      {
        name: 'a',
        components: {
          'card': {
...
describe('slot', () => {
  it('插槽', () => {
    assertCodegen(
      ...
      `<template name="a"><view class="_div testModuleId"><template name="default">test</template><block><block wx:if="{{$slotdefault}}"><template data="{{...$root[$p], ...$root[$k], $root}}" is="{{$slotdefault}}"></template></block><block wx:else><template data="{{...$root[$p], ...$root[$k], $root}}" is="{{'default'}}"></template></block></block></view></template>`,
      {
        name: 'a',
  ...
  it('使用', () => {
    assertCodegen(
      ...
      `<template name="a"><view class="_div"><template name="w">test</template><block><block wx:if="{{$slotw}}"><template data="{{...$root[$p], ...$root[$k], $root}}" is="{{$slotw}}"></template></block><block wx:else><template data="{{...$root[$p], ...$root[$k], $root}}" is="{{'w'}}"></template></block></block></view></template>`,
      {
        name: 'a'
      }
    )
  ...
  it('含`:name`的插槽组件', () => {
    assertCodegen(
      ...
      `<template name="a"><view class="_div"><template name="default">test</template><block><block wx:if="{{$slotdefault}}"><template v-bind:name="tab.key" data="{{...$root[$p], ...$root[$k], $root}}" is="{{$slotdefault}}"></template></block><block wx:else><template v-bind:name="tab.key" data="{{...$root[$p], ...$root[$k], $root}}" is="{{'default'}}"></template></block></block></view></template>`,
      {
        name: 'a'
      }
    )
